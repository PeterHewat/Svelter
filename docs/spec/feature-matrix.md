...
Acronyms: **PLG** = product-led growth (self-serve signup and public pricing as the default GTM motion). Defined in [v0/marketing.md](./v0/marketing.md).
...
| F-03 | Marketing site           | v0    | Visitor        | marketing `/*`          | [v0/marketing.md](./v0/marketing.md)                 | Shipped |
